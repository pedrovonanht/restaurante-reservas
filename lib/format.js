...
// Percentual de ocupação (0–100), a partir do objeto `ocupation` da API.
export function occupancyPercent(ocupation) {
  if (!ocupation || !ocupation.capacity) return 0;
  const pct = (ocupation.reservations / ocupation.capacity) * 100;
